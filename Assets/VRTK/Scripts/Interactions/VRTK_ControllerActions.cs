...
namespace VRTK
{
    ...
    {
        [Tooltip("The GameObject that contains the actual renderers for the controller model. Will default to the model alias controller GameObject if none is provided.")]
